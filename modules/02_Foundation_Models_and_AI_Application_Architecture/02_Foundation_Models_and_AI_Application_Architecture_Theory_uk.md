...
>
> **Примітка щодо нумерації сторінок джерел:** Номери сторінок у блоках `Further reading` стосуються поточного робочого PDF-видання *AI Engineering*. Вони залежать від конкретного видання, і їх необхідно перевіряти повторно, якщо курс переходить на інше друковане, EPUB-, PDF- або онлайн-видання. Дві робочі копії EPUB із програмної архітектури не мають стабільних номерів сторінок, тому як локатори використовуються назви розділів і підрозділів.
...
2. **Status and lifecycle links:** Proposed. Наданий бриф системи та базова лінія вимог усе ще перебувають на розгляді викладача, тому цей запис ще не є прийнятим повноваженням на реалізацію. Він не заміщує жодного попереднього ADR.
...
8. **Notes and metadata:** це ілюстративний навчальний запис. Original author: course material team. Created: 14 September 2026. Last modified: 17 September 2026. Approval date and approved by: pending; базова лінія вимог призначає власність рішення викладачеві курсу. Related candidate ADRs concern the stable model-access port, the structured candidate contract, and the model-disabled fixture path. Superseded date and superseding ADR: not applicable.
...
Точні назви артефактів Лабораторної роботи 02, потрібні докази живої моделі, контракт фікстури відтворення та мінімальне твердження про переносимість залишаються поза цим проєктом теорії. Їх необхідно вивести з розглянутої теорії та підтверджених вимог проєкту.
